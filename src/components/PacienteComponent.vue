<script setup>
defineEmits(["actualizar-pacientes", "eliminar-paciente"]);
defineProps({
  paciente: {
    type: Object,
    required: true,
...
<template>
  <div class="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl text-left">
    ...
    <div class="grid md:grid-cols-2 gap-5 mt-10">
      <button
        ...
        @click="$emit('actualizar-pacientes', paciente.id)">
        Editar
      </button>
